        ...
        <div className="container-fluid">
            <div className="row">
                ...
                <div className="col-12 col-md-6">
                    ...
                    <p> Hi, I'm Yu Liang. I was born in 1994. Experienced in Perl, Building several simple websites with HTML, CSS, and JavaScript for our own department,and I build it in LAMP environment. Seeking to become the next front end developer. </p>
